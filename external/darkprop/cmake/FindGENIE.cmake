# https://github.com/DUNE/wp1-neardetector/blob/729c30532670679b7c87131ec70b4141d04a3ede/cmake/FindGENIE.cmake
...
## Find the GENIE headers and libraries relying on the information provided
## by the genie-config script.
find_program(GENIE_CONFIG_EXECUTABLE
             NAMES genie-config
             HINTS $ENV{GENIE}/bin
             DOC "Specify the path to the GENIE headers and binaries.")

if(EXISTS "${GENIE_CONFIG_EXECUTABLE}")
  ## Find the GENIE headers
  execute_process(COMMAND ${GENIE_CONFIG_EXECUTABLE} --topsrcdir
                  OUTPUT_VARIABLE GENIE_INCLUDE_DIR
                  RESULT_VARIABLE GENIE_INCLUDE_DIR_RESULT
                  OUTPUT_STRIP_TRAILING_WHITESPACE)

  if("${GENIE_INCLUDE_DIR_RESULT}" STREQUAL "0")
    mark_as_advanced(GENIE_INCLUDE_DIR)
  else()
    unset(GENIE_INCLUDE_DIR)
  endif()
